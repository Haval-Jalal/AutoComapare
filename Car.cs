...
namespace AutoCompare
{
    ...
    public class Car
    {
        ...
        public Recommendation Recommendation { get; set; } //här ta bort private public Recommendation Recommendation { get; private set; }
        ...
        //här lägga till DateTime carAge
        public Car(string regNumber, string brand, string model, int year, int mileage,
                   int owners, int insuranceClaims, List<string> knownIssues, DateTime carAge)
        {
            ...
            CarAge = carAge;                                    //här lägga till CarAge = carAge
            CarAge = DateTime.Now;
